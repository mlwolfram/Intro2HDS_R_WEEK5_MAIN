...
fev_data <- read_csv(here("INPUTS/WEEK5/fev.csv")) # Edit the path to reflect the correct folder structure
```
...
```{r}
# Add your code here!
psa_data <- read_table(here("INPUTS/WEEK5/psa.txt"))
```
...
```{r}
# Add your code here!
fev_data <- read_csv(here("INPUTS/WEEK5/fev.csv"), col_names = TRUE, n_max = 10)
```
